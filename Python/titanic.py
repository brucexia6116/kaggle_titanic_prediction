...
# Random Forest loop to find the best paramters for the algo 
"""
highScore = 0
highestrandomNUM = 0
...
"""
#random forest algo
alg = RandomForestClassifier(random_state=1, n_estimators=58, min_samples_split=2, min_samples_leaf=3)
...
algorithms = [
        ...
        [
            RandomForestClassifier(random_state=1, n_estimators =250, min_samples_split=3, min_samples_leaf=9),
            predictors
            ]
        ]
